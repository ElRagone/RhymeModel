...
class RhymeModel(object):
    ...
    def __init__(self, dataset):
        self.lyrics_df = pd.read_csv(dataset, index=(0,1))
    ...
    def endrhyme(line, next_line, max_skip=1):
